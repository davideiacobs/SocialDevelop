...
CREATE TABLE `task_has_developer` (
  ...
  CONSTRAINT `fk_sender` FOREIGN KEY (`sender`) REFERENCES `developer` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_task_has_developer_developer1` FOREIGN KEY (`developer_ID`) REFERENCES `developer` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `task_has_developer` VALUES (1,1,1,'1995-07-21',-1,1),(1,58,1,'1995-01-21',-1,1),(8,58,1,'1995-01-21',-1,1),(11,58,2,'2017-09-21',5,1),(12,58,2,'2017-09-21',5,1),(41,3,0,'2017-07-01',-1,1),(41,9,0,'2017-07-01',-1,1),(41,58,0,'2017-07-02',-1,58),(42,3,2,'2017-09-21',4,NULL),(42,9,1,'2017-09-21',-1,NULL),(42,129,0,'2017-07-02',-1,58);
